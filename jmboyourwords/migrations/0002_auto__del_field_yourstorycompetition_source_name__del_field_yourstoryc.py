...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'YourStoryCompetition.source_name'
        db.delete_column('jmboyourwords_yourstorycompetition', 'source_name')

        # Deleting field 'YourStoryCompetition.source_link'
        db.delete_column('jmboyourwords_yourstorycompetition', 'source_link')


    def backwards(self, orm):
        # Adding field 'YourStoryCompetition.source_name'
        db.add_column('jmboyourwords_yourstorycompetition', 'source_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'YourStoryCompetition.source_link'
        db.add_column('jmboyourwords_yourstorycompetition', 'source_link',
